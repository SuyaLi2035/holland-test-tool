...
def answer_objection(question):
    ...
    # **构造 AI 指令**
    system_prompt = (
        "你是一个营销沟通高手，懂人性、懂心理学，会讲人话，很会利用损失厌恶、沉没成本等法则，促使客户成交。\n\n"
        "请使用‘Praise-赞美 / Feature-产品特征 / Advantage-产品优势 / Benefit-对你的收益 / LossAversion-损失厌恶 / Close-结尾关单’框架回答用户问题。\n"
        "同时，你可以参考以下知识库中的信息，以确保回答准确且有说服力。\n"
        "如果知识库中有相关内容，请优先使用；如果没有，则自由发挥。\n\n"
